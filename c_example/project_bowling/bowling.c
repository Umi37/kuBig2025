...
void viewMembers();
void print_menu();
void updateMonthlyStats(char *name, char *play_date);
...
void registerMember()
{
    ...
    snprintf(query, sizeof(query),
             "INSERT INTO score (name, score, play_date) VALUES ('%s', '%s', NULL, NULL)",
             name);
...
void updateMonthlyStats(char *name, char *play_date)
{
    ...
    snprintf(query, sizeof(query),
             "INSERT INTO monthly_stats (name, month_year, games_played) "
             "VALUES ('%s', '%s', 1) "
...
void insertGameResult(char *name, int totalScore, char *play_date)
{
    MYSQL *conn = connect_db();
    char query[512];

    snprintf(query, sizeof(query),
             "INSERT INTO score (name, score, play_date) "
             "VALUES ('%s', %d, '%s') "
             "ON DUPLICATE KEY UPDATE score = %d, play_date = '%s'",
             name, totalScore, play_date, totalScore, play_date);
...
void playGame(Player *player1, Player *player2) {
    ...
    insertGameResult(player1->name, player1->totalScore, game.play_date);
    updateMonthlyStats(player2->name, game.play_date);
